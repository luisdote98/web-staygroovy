  ...
  return (
    <article className="flex flex-col gap-3">
      ...
      <Link
        ...
        className="block relative aspect-[4/5] bg-transparent overflow-hidden rounded-sm border border-[#c9a84c]/40 hover:border-[#c9a84c] transition-colors duration-300"
