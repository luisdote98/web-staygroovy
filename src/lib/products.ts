...
export const products: Product[] = [
  ...
  {
    id: "tee-white",
    slug: "stay-groovy-tee-white",
    name: "Stay Groovy Oversize Tee White",
    nameEs: "Camiseta Oversize Blanca",
    category: "tee",
    color: "white",
    colorLabel: "Blanco",
    colorHex: "#f5f5f5",
    ...
    sizes: ["M", "L", "XL"],
    images: {
      product: "/products/tee-white-product.png",
      model: "/models/model-tee-side.jpg",
    },
    description:
      "Camiseta oversize 100% algodón con gráfica Stay Groovy frontal y diseño principal en espalda. Una pieza pensada para llevar dentro y fuera del club.",
    isLaunch: true,
